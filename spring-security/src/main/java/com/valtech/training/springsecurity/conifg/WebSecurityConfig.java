package com.valtech.training.springsecurity.conifg;
...
public class WebSecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity security) throws Exception{
		...
		security.authorizeHttpRequests(requests->requests.requestMatchers("/hello","/login","/logout","/register","/jsps/**").permitAll()
