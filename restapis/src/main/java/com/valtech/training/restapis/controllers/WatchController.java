...
//	}
	@GetMapping("/{id}")
	public WatchVO getWatch(@PathVariable(name = "id") long id) {
	...
	@PutMapping("/{id}")
	public WatchVO updateWatch(@PathVariable(name = "id") long id ,@RequestBody WatchVO watch) {
		return watchService.updateWatch(watch, id);
	}
}
