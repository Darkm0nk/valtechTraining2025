...
public class LeaveController {
	...
	@PostMapping("/approve")
	public LeaveVO approveLeave(@RequestBody approveLeaveVo appVO) {
		return leaveService.approveLeave(appVO);
	}
	...
	@GetMapping("/{id}")
	public LeaveVO getLeave(@PathVariable(name = "id")long id) {
	...
	@PutMapping("/{id}")
	public LeaveVO updateLeave(@PathVariable(name = "id") long id,@RequestBody LeaveVO vo) {
