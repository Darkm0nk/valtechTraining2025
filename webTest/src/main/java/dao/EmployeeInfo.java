...
public class EmployeeInfo implements Comparable<EmployeeInfo>{
	...
	public EmployeeInfo(long id, String name, int age, float salary, Gender gender, int level, int exp , int departmentId) {
		super();
		this.id = id;
		this.name = name;
		this.age = age;
	...
	public boolean equals(Object obj) {
		...
		return age == other.age && departmentId == other.departmentId && exp == other.exp && gender == other.gender
				&& id == other.id && level == other.level && Objects.equals(name, other.name)
				&& Float.floatToIntBits(salary) == Float.floatToIntBits(other.salary);
	}

	public static List<EmployeeInfo> getEmp() {
		return emp;
	}

	public static void setEmp(List<EmployeeInfo> emp) {
